...
export const cadastrarProduto = async (produto:Produto) =>{
    ...
    const sql = 'insert into produtos(nome, preco, quantidade, medida, categoria) values(?,?,?,?,?)';
    const values = [produto.nome, produto.preco, produto.quantidade, produto.medida, produto.categoria];
